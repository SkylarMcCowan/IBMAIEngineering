...
print("KNN model trained with n_neighbors set to 4")

# Use the predict method on the testing data
predictions = KNN.predict(X_test)

# Optionally, you can print the first few predictions to verify
print("First few predictions from KNN model:", predictions[:5])
...
# Optionally, you can print the first few predictions to verify
print("First few predictions from the Decision Tree model:", predictions[:5])